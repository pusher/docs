    ...
    res.status(200).send(
      ...
      <html lang="en">
        ...
        <body class="pa5 mw7 center">
          <a class="flex items-center link eggplant hover-dragonfruit" href="https://pusher.com/">
          ...
          <footer class="f6 pv3 ph4 steel">
            <p class="ma0">Search powered by <a href="https://www.algolia.com/" class="link eggplant hover-dragonfruit underline">Algolia</a></p>
            <p class="mt6 measure-wide">This page is the fallback search for when JavaScript search is unavailable. The docs are statically generated with <a href="https://www.11ty.dev/" class="link eggplant hover-dragonfruit underline">11ty</a> but this page runs on <a href="https://vercel.com" class="link eggplant hover-dragonfruit underline">Vercel</a> as a <a href="https://vercel.com/docs/serverless-functions/introduction" class="link eggplant hover-dragonfruit underline">serverless function</a>. You can see <a href="https://github.com/pusher/docs/blob/main/api/search.js" class="link eggplant hover-dragonfruit underline">the source code on&nbsp;Github</a>.</p>
          </footer>
        </body>
      </html>`
    );
